...
=head1 Manuel, the Magnificent Mechanical Man: A novel. Book One


=head2 Prologue

This novel is released under a free license. Please check L<its web for
...
liking), or just talking about it.  You can follow its evolution L<in
Twitter @hoborg_novel|http://twitter.com/hoborg_novel>. 


=head2 Meet the mechanical man
...
And I'm using I<he> liberally here, since I'm talking about a
...
way out than to be attached to it. On the other hand, the
...
=head2 Who wants a mechanical man?
...
where, if worse came to worst, I could have many 
...
nondescript. Hey, I said that already. Weren't you listening?
...
done, right? Well, you know now that some harm would be I<eventually>
...
ten thousand more when I got them something, something which they really, really
...
=head2 A rolling teakettle with ears
...
Eyes. Did I say anything about the whole fucking I<face>? No proper
...
drift... so if that upside down bucket is a I<head>, the grilled gap on the bottom, that
...
healthy, people would be all "Your dummy is I<burning>!."
...
=head2 Here's a bit of money to get you started
...
=head2 Duke of Poo tells his story
...
Thanks, Captain, we I<former> soldiers have to respect and care for
...
=head2 Down and out and with ten thousand pesos in Mobile and Panama City.
...
=head2 Hey, are you interested in the mechanical man?
...
=head2 The day they took the railway from me
...
=head2 Buying elephants from a circus

I have never been in the army. Did you hear me saying I was a soldier? No way, Captain,
I would have said that if I I<had> been in the army, which I
...
=head2 I married a bearded woman
...
=head2 You don't look like a circus person
...
they call I<red> gauchos. That's why I did not have other way out that
...
=head2 Gummy Eddie tells his story. Actually, no, Captain Corporal tells Gummy Eddie's story
...
=head2 There's a lot of vice in Miami
...
not mean I have to I<like> them, right? I could have liked this one,
...
see how Tracy was doing. Not that I could actually I<get> in there, you
...
made one or two dents, but all of a sudden one of them, the I<father>,  realized their prey
...
know now, is when you sell a mark the key to your I<girlfriend>
...
=head2 We didn't start the fire
...
And then there was Tracy. Couple of days after the I<incident>, when we
...
=head2 The second greatest show on earth goes to New Orleans
...
I<wanted> to get to the very end of the prow; every time I veered away
...
=head2 Parade of the monsters in New Orleans
...
=head2 Terrible Trouble in Tremé
...
=head2 By the people, for the people
...
=head2 Settling accounts with the clowns
...
worry about that." But I wasn't worried about I<that> part. That 
...
=head2 Gaffe building for fun and profit
...
a gaffe that I<looked>, in fact, nothing like the real Manuel? 
...
looked and I<acted> like the mech. 
...
I<act> part the one that had to go. No way something that actually
...
to step on them. This they don't like. I<revise and write>
...
=head2 Crocodile tears

I cried like I've seen the clowns doing in their act. Close your eyes
just so, open your mouth, and wail a trembling I<a> for as long as you
...
=head2 Talking with the circus manager
...
=head2 Mechanical workers or the gears of capitalist evil
...
"Take a good pee, Full." They called me Full. Not Fool. I<You> are fools. 
...
=head2 Helping those who help you
...
brakemen and they can be brutal if they find you in I<their>
...
he owned them, that is rich, because he I<actually> owned them, and
...
that happen, right? I expect that if you want to I<actually> do it, my
...
real name is not Juan but Jaime, ha ha, actually not joking I<at all>
...
=head2 With the hobos around the fire
...
unknown. So I would like to dedicate it to the people that L<answered
my question on symbols on the History
StackExchange|http://history.stackexchange.com/questions/8894/looking-for-a-symbol-for-southern-usa-communism> and then L<another
